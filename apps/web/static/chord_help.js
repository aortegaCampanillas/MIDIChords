...
const CHORD_VARIANT_GROUPS = [
  ...
  { labelKey: "chord_group_add", suffixes: ["add2", "add4", "madd2", "madd4", "add9", "madd9"] },
...
const CHORD_VARIANT_THEORY = {
  ...
  "madd2": ["1 - 2 - ♭3 - 5", "Añade una segunda mayor a la tríada menor sin sustituir la tercera. La cercanía entre segunda y tercera menor crea una tensión compacta y melancólica, mientras la quinta conserva la estabilidad del acorde.", "This chord adds a major second to a minor triad without replacing the third. The close second and minor third create compact, melancholic tension while the fifth preserves the chord's stability."],
  "madd4": ["1 - ♭3 - 4 - 5", "Añade una cuarta justa a la tríada menor manteniendo su tercera. La cuarta amplía el color modal y forma un grupo denso con tercera y quinta, habitual en acompañamientos abiertos y sonoridades ambientales.", "This chord adds a perfect fourth to a minor triad while retaining its third. The fourth broadens the modal color and forms a dense third-fourth-fifth cluster common in open and atmospheric voicings."],
