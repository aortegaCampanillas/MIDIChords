...
- **Móvil (ayuda)**: la explicación del pentagrama de Generación de intervalos se diferencia explícitamente de Detección e indica que permite previsualizar y resaltar las notas elegidas sin cambiar el intervalo.
- **Web (ayuda)**: Generación de intervalos deja de reutilizar en el pentagrama el texto de “las dos últimas notas pulsadas” de Detección y describe su selección e interacción reales.
