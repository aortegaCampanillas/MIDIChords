...
UI_TEXTS = {
    "es": {
        ...
        "help_interval_gen_instrument": "Vista del intervalo generado en el instrumento seleccionado. Las notas se muestran como referencia; usa los botones de reproducción para escucharlas.",
    ...
    "en": {
        ...
        "help_interval_gen_instrument": "View of the generated interval on the selected instrument. Notes are shown as a reference; use the playback buttons to hear them.",
        # Generation — result
