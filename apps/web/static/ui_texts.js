...
const UI_TEXTS = {
  es: {
    ...
    help_interval_gen_field_name: "Nombre del intervalo seleccionado en la tabla.",
    ...
    help_note_detection_result: "Nota: nombre y octava de la última nota tocada.",
  ...
  en: {
    ...
    help_interval_gen_field_name: "Name of the interval selected in the table.",
    ...
    help_note_detection_result: "Note: name and octave of the last played note.",
