...
UI_TEXTS = {
    "es": {
        ...
        "help_note_detection_result": "Muestra el nombre y la octava de la última nota tocada.",
    ...
    "en": {
        ...
        "help_note_detection_result": "Shows the name and octave of the last note played.",
