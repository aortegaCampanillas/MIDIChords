...
const UI_TEXTS = {
  es: {
    ...
    help_staff_interval_generation: "Pentagrama del intervalo generado: muestra las dos notas elegidas en la tabla. Pulsa una para previsualizarla y resaltarla en el piano o la guitarra; no detecta ni cambia el intervalo.",
  ...
  en: {
    ...
    help_staff_interval_generation: "Generated interval staff: shows the two notes selected in the table. Click one to preview it and highlight it on the piano or guitar; this does not detect or change the interval.",
