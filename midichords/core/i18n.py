...
UI_TEXTS = {
    "es": {
        ...
        "help_interval_gen_play": "Reproduce las dos notas del intervalo de forma melódica.",
        "help_interval_gen_play_reverse": "Reproduce el intervalo de forma descendente (nota alta → nota baja).",
    ...
    "en": {
        ...
        "help_interval_gen_play": "Play the two interval notes melodically.",
        "help_interval_gen_play_reverse": "Play the interval descending (high note → low note).",
