...
UI_TEXTS = {
    "es": {
        ...
        "help_circle_panel": "Círculo de quintas: elige la tonalidad con el ratón; con Mayús, un acorde diatónico.",
        ...
        "help_gen_instrument": "Teclado/guitarra del acorde generado: al pulsar una nota se resalta en el pentagrama, y al pulsar una nota del pentagrama se marca en el instrumento.",
        # Círculo de quintas
        "help_circle_canvas": "Círculo de quintas: cada sector es una tónica posible. Clic para fijar la tonalidad; Mayús+clic para elegir un acorde diatónico.",
        ...
        "help_scale_instrument": "Teclado/guitarra de escala: toca notas de la escala y las verás en el pentagrama; también puedes seleccionar hasta 3 octavas y ver la digitación sugerida.",
        ...
        "help_metro_instrument": "Piano del metrónomo: muestra las notas que entran por MIDI y permite ver qué tocas mientras el metrónomo corre.",
    ...
    "en": {
        ...
        "help_circle_panel": "Circle of fifths: choose the key with the mouse; Shift for a diatonic chord.",
        ...
        "help_gen_instrument": "Generated-chord keyboard/guitar: pressing a note highlights it on the staff, and pressing a staff note highlights it on the instrument.",
        # Circle of fifths
        "help_circle_canvas": "Circle of fifths: each sector is a possible key. Click to set the key; Shift+click to pick a diatonic chord.",
        ...
        "help_scale_instrument": "Scale keyboard/guitar: play scale notes and see them on the staff; you can also select up to 3 octaves and view the suggested fingering.",
        ...
        "help_metro_instrument": "Metronome piano: shows notes coming in via MIDI so you can see what you're playing while the metronome runs.",
