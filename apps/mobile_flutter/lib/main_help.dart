    ...
    final modeSpecific = switch (_tabIndex) {
      ...
      1 => <_HelpStep>[
        ...
        _HelpStep(
          ...
          bodyEs: 'Alterna la vista y la reproducción entre piano y guitarra.',
          bodyEn: 'Switches the view and playback between piano and guitar.',
          side: _HelpCalloutSide.top,
          highlightPadding: 2,
        ),
        _HelpStep(
      ...
      2 => <_HelpStep>[
        ...
        _HelpStep(
          ...
          titleEs: 'Piano',
          titleEn: 'Piano',
          bodyEs: 'Alterna la vista entre piano y guitarra.',
          bodyEn: 'Switches the view between piano and guitar.',
          side: _HelpCalloutSide.left,
        ),
        _HelpStep(
      ...
      7 => <_HelpStep>[
        ...
        _HelpStep(
          ...
          titleEs: 'Botón Piano',
          titleEn: 'Piano button',
          bodyEs: 'Alterna la representación entre piano y guitarra.',
          bodyEn:
              'Switches the instrument representation between piano and guitar.',
          side: _HelpCalloutSide.top,
          highlightPadding: 2,
        ),
        _HelpStep(
