...
const List<Map<String, dynamic>> _kChordPatternDefs = chordPatternDefs;
const Set<String> _kScaleBasicNames = scaleBasicNames;
const List<Map<String, dynamic>> _kScalePatternDefs = scalePatternDefs;
const List<String> _kCommonChordSuffixOrder = commonChordSuffixOrder;
const Map<String, String> _kChordSuffixNamesEs = chordSuffixNamesEs;
const Map<String, String> _kChordSuffixNamesEn = chordSuffixNamesEn;
const List<String> _kInversionNamesEs = inversionNamesEs;
const List<String> _kInversionNamesEn = inversionNamesEn;
const Map<String, String> _kScaleNameEs = scaleNameEs;
